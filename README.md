...
Second, check [the troubleshooting page](https://github.com/toebeann/BepInEx.MegastoreSimulator/wiki/Troubleshooting) to see if there is a solution to your problem there.
